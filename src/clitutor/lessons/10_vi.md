...
<!-- exercise
id: ex01
title: Create a file with vi-style workflow
xp: 10
difficulty: 1
sandbox_setup: null
validation_type: file_contains
expected: vifile.txt::hello from vi
hints:
  - "For this exercise, create the file using echo (simulating a vi save)."
  - "We are simulating the result of a vi editing session."
  - "Type: `echo 'hello from vi' > vifile.txt`"
-->
### Exercise 1: Create a file (simulated vi save)
Create a file called `vifile.txt` containing `hello from vi` (simulating saving in vi).
